...
public class XMLLexicon extends Lexicon {
	...
	private void createLexicon(URI lexiconURI) {
		...
		try {
			...
			// Log.d("createLexicon: javax.xml.parsers.DocumentBuilder.parse",
			// "before");
			Document doc = builder.parse(lexiconURI.toString());
			// Log.d("javax.xml.parsers.DocumentBuilder.parse", "after");
			...
			if (doc != null) {
				...
				// Log.d("createLexicon", "end");
				// TODO: this routine above takes 22s on HTC Desire 1Ghz!
			}
	 ...
	 * 
	 *             access level modifier changed by Pierre-Luc Vaudry from
	 *             private to protected to allow overriding in subclass
	 */

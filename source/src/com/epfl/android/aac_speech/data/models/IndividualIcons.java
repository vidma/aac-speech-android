...
public class IndividualIcons {
	public static final String TABLE_NAME = "icon_meanings";

	public static final String PATH_STR = TABLE_NAME + "_listing_full";
	public static final String URI_STR = PhraseProviderDB.URI_AUTHORITY
			+ PATH_STR;

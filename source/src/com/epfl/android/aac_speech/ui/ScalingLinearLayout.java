...
import com.epfl.android.aac_speech.ui.util.Scale;
...
public class ScalingLinearLayout extends LinearLayout {
	...
	private void updateMeasures() {
		...
		this.measure(1500, 1000); // TODO: Adjust this up if necessary.
	...
	public void draw(Canvas canvas) {
		...
		if(!this.alreadyScaled || width != this.expectedWidth || height != this.expectedHeight) {
			...
			// Scale the layout.
			this.scale = Math.min(xScale, yScale) * (float)0.99; // add some extra to make sure the contents fit..
			// TODO
